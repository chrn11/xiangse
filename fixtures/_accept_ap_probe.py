#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""AP 验收：强化 post-cb 故障捕获 + LBFHook QF 窗重入/开销；KEEP AK/strftime/inThread；前台硬断言萧炎。"""
...
OUT = ROOT / "fixtures" / "_accept_ap_probe.json"
SYNC = ROOT / "fixtures" / "_accept_ap_probe_sync.json"
KILL = ROOT / "fixtures" / "_accept_ap_kill_syslog.json"
...
def main() -> int:
    ...
    (ROOT / "analysis" / "reader-forensics" / "ap_fault_summary.json").write_text(
